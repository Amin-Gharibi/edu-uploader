import { createFocusedSubject, deleteFocusedSubject, editFocusedSubject, getAllFocusedSubjects, getOneFocusedSubject } from "./funcs/focusedSubjects.js"
import { createToast } from "./util/toastNotification.js"

async function handlePanelFocusedSubjectContent () {
    ...
    dynamicContentContainer.innerHTML = `
                ...
                <div class="all-focused-subjects-section-container max-w-[330px] xs:max-w-[390px] md:max-w-[490px] lg:max-w-[700px] xl:max-w-max mt-12 w-full ruonded p-5 customBoxShadow flex flex-col gap-y-6">
        ...
        return `
                                    <tr>
                                        ...
                                        <td>
                                            <button data-value="${focusedSubject.enTitle}" class="edit-btns text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded sm:rounded-lg py-1.5 px-5 text-sm focus:outline-none">
                                                ویرایش
                                            </button>
                                        </td>
                                        <td>
    ...
    const editHandler = async (btn) => {
        ...
        const focusedSubject = await getOneFocusedSubject(btn.dataset.value.trim())

        
        const allFocusedSubjectsSectionContainer = document.querySelector('.all-focused-subjects-section-container')
        allFocusedSubjectsSectionContainer.classList.add('hidden')
        ...
        titleInput.value = focusedSubject.title
        enTitleInput.value = focusedSubject.enTitle
        ...
        const data = await editFocusedSubject(focusedSubject._id, titleInput.value.trim(), enTitleInput.value.trim())
        ...
        if (data.ok) {
            ...
            focusedSubjectsContainer.insertAdjacentHTML('beforeend', `
                    <tr>
                        ...
                        <td>
                            <button data-value="${focusedSubject._id}" class="edit-btns text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded sm:rounded-lg py-1.5 px-5 text-sm focus:outline-none">
                                ویرایش
                            </button>
                        </td>
                        <td>
...
export {
    handlePanelFocusedSubjectContent
}