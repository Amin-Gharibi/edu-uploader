...
import { createSideBarMenu, deleteSideBarMenu, getAllSidebarMenus } from "./funcs/sidebarMenu.js"
        ...
        <div class="relative flex w-full min-h-full h-max">
            <div class="menu absolute z-[100] sm:sticky top-0 bottom-0 -right-full sm:right-0 h-screen overflow-hidden w-56 sm:min-w-44 md:min-w-52 md:w-64 xl:w-80 bg-gray-800 p-4 transition-all">
                ...
                <ul class="overflow-y-auto h-[calc(100%-100px)] space-y-2 mt-5 border-t border-gray-600 pt-8 text-gray-500 cursor-default hideScrollbar">
                    <li data-value="me" class="nav-menu--links w-full relative p-2 hover:text-gray-300 border border-transparent hover:border-gray-300 rounded [&.active]:border-gray-300 [&.active]:text-gray-300 group cursor-pointer transition-colors active">
                        من
                            ...
                            ${allQuickAccessLinks.length && allQuickAccessLinks.map(quickAccessLink => {
                                return `
                                    <tr>
                                        ...
                                        <td>
                                            <button data-value="${quickAccessLink._id}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded sm:rounded-lg py-1.5 px-5 text-sm focus:outline-none">
                                                ویرایش
                                            </button>
                                        </td>
                                        <td>
